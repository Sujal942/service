...
//       const intervalId = setInterval(() => {
//         // Hide the table with the unwanted Google class
//         const googleTable = document.querySelector(
//           'table[class="VIpgJd-ZVi9od-ORHb-KE6vqe"]'
//         );
//         if (googleTable) {
//           googleTable.style.display = "none"; // Hide the table
//         }
